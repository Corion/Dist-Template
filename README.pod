...
Dist::Template - CORIONs distrubtion template
...
Copy the template into your new (or existing) distribution
...
Update the meta-files
    ...
    perl -w tools/update-meta.pl

=item 3

Add release date to C<Changes>
...
Release using L<Module::Release>
